...
!!! tip "Dica"
    Lembre-se de visitar a seção [Configuração Recomendada](configuracao.md) para certificar-se de que você está usando as configurações ideais para a nossa região e caso de uso!
