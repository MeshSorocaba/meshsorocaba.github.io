...
Foi nesse contexto que Scott Powell, também engenheiro de software, [lançou em 2024 o **MeshCore**](https://www.hackster.io/scottpowell69/the-r2-mesh-system-695f4b). Enquanto o Meshtastic se propunha a ser uma ferramenta universal para redes mesh, o MeshCore partia de uma premissa restritiva e deliberada: menos foco em telemetria e transmissões desnecessárias, **mais foco na troca de mensagens**.
